    ...
    <>
      <div className="pt-3 cursor-pointer pb-6 flex item-center space-x-12">
        <div
          ...
          className="pb-4 flex flex-col items-center space-y-2 border-b-2 border-black opacity-60 hover:opacity-100 hover:border-gray-200"
        >
        ...
        <div
          ...
          className="pb-4 flex flex-col items-center space-y-2 border-b-2 border-white opacity-60 hover:opacity-100 hover:border-gray-200"
        >
